...
- Allows discord users to get a randomly rolled tier for world of tanks. Tiers can not repeat. Tier I is limted to once per day. The base odds of tier I, II, and III are halved. Tier I, II, and III are only availble at certain times of day.
Tier I, II, and III can be disabled entirely using the battle pass version of the command. At tiers II, IV, V, VI, VII, and VIII, preferential tiers can be rolled with 1 in 30 chance.
...
Then run the following yaml file in Docker:
